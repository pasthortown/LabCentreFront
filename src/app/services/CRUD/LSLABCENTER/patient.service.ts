...
export class PatientService {
   ...
   url = environment.api_lslabcenter + 'patient/';
   ...
   search(filter?: String): Promise<any> {
      return this.http.get(this.url + 'search?filter=' + filter, this.options).toPromise()
      .then( r => {
         return r;
   ...
   post(patient_data: any): Promise<any> {
      return this.http.post(this.url, JSON.stringify(patient_data), this.options).toPromise()
      .then( r => {
         return r;
      }).catch( error => { this.handledError(error); });
   }

   put(patient_data: any): Promise<any> {
      return this.http.put(this.url, JSON.stringify(patient_data), this.options).toPromise()
      .then( r => {
         return r;
      }).catch( error => { this.handledError(error); });
   }
